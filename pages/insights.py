...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            (The [Sample Data](https://not-a-hot-spring-finder.herokuapp.com/data) page has a random selection of rows that can be used to try out the model. Enter the latitude and longitude values into a map to locate the county in question and see if you can find the nearest thermal spring!)
            ...
            However, because of the imprecise nature of the target variable, when the model accurately predicts a spring is close by, that means one is somewhere inside a circle with a radius of 20 miles, which is equivalent to 1,257 square miles. 

            Therefore, in the alien invasion scenario, the resistance forces would still have a lot of work to do after getting a prediction. Searching 1,000-plus square miles of Wyoming for a thermal spring is no mean feat, though at least this model is highly unlikely to send them searching some county in Iowa for a nonexistent spring. 
            ...
            The graphic on the [home page](https://not-a-hot-spring-finder.herokuapp.com/) is a scatter plot of the latitudes and longitudes of all the “swimmable” springs included in the model. If you squint, it is possible to see a rough outline of the continental United States. The springs are overwhelmingly concentrated west of the Mississippi River, mostly in the Rocky Mountains and the Pacific coast ranges, with a smaller number in the Appalachian Mountains in the east. 

            These mountainous areas tend to be rural, which means people rely on automobiles rather than public transport; to have smaller minority populations, especially in the Mountain West; and to have large areas of federal- and state-owned land, which are managed by government employees. And these three traits are reflected in the five most important features in permutation: the percentage of the population who drive to work, the mean commute time, the percentages of the population who are hispanic and black, and the percentage who work in the public sector. These areas also tend to be poorer, which is reflected in the sixth and seventh most important features (income per capita, child poverty rate). Only the top five were included in the model.  
            ...
            A final note on feature engineering. Though I did very little for this project, it might be possible to improve the model with some creative ideas. Building on the traits mentioned above could be fruitful. Adding elevation to the data is one thing that could have a big impact, as most thermal springs are located in the mountains. But this almost feels like feature leakage, and it might blow the cover story of the model being a harmless demographic tool. Another idea I had was to combine the most important factors (race, car use, poverty) into a general index. 
